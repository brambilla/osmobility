...
public class MaximumSpeedModel extends MobilityModel {
	...
	public Double evaluateMove(Integer key, Location location, Location nextLocation, Path path) {
		try {
			...
			Double maximumSpeed = path.getOSMWay(location, nextLocation).getMaximumSpeed(path.getOSMDirection(location, nextLocation));
